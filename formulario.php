...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->Password   = 'wkyo avrk bpqa couf';              // SMTP password
        ...
        if ($mail->send()) {
            ...
            header("Location: 404.html?msg=Error al enviar el mensaje: " . $mail->ErrorInfo);
            exit();
        }
    } catch (Exception $e) {
        header("Location: 404.html?msg=Error inesperado: " . $e->getMessage());
        exit();
    }
}
?>
